...
**[Launch the App](https://tcrowson.github.io/houdini_nodeshape_designer/)**

---

![Houdini NodeShape Designer](https://github.com/tcrowson/houdini_nodeshape_designer/blob/main/wiki/img/preview.png)
...
- **Transform gizmo** — scale, rotate, and translate multi-point selections with bounding box handles
...
- [[Using the Designer]] — tools, layers, curves, gizmo, ports, snapping, presets, exporting
- [[Installing in Houdini]] — step-by-step installation for Linux, macOS, and Windows
- [[JSON Format Reference]] — the node shape spec explained
- [[Keyboard Shortcuts]] — full shortcut reference

---

*By Tim Crowson, with Claude AI (Anthropic)*
